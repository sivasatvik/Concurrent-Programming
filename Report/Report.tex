...
The TSP has many applications such as planning, logistics and the manufacture of \textbf{microchips}, also is a sub-problem in \textbf{DNA sequencing}. This is also used in astronomy, as astronomers observing many sources will want to minimize the time spent moving the telescope between the sources.\newline\newline So, in this report, we present two exitsting algorithms for \textbf{TSP}. They are: 
	\begin{itemize}
...
\section*{Genetic Algorithm}
	...
	As the brute force algorithm for this problem will give us a complexity of \textbf{$O(n!)$}, this algorithm approaches the problem in an interesting way. This algorithm can be divided into following sections:
	\begin{itemize}
		\item Choosing few aribitrary solutions
